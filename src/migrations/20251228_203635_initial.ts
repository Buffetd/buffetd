...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'tSaveEntry', 'tExecuteJob', 'tFetchSourceEntry', 'tSendEmail', 'schedulePublish');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'tSaveEntry', 'tExecuteJob', 'tFetchSourceEntry', 'tSendEmail', 'schedulePublish');
  ...
  CREATE TABLE "sources" (
  	...
  	"name" varchar,
  	"description" varchar,
  	"key_template" varchar DEFAULT '/',
  	"default_headers" jsonb DEFAULT '{}'::jsonb,
  	"rate_limit" jsonb DEFAULT '{}'::jsonb,
  	"cache_t_t_l" numeric DEFAULT 3600,
  	"supports_pool" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
